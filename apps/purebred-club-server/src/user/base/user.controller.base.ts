...
import { BreederFindManyArgs } from "../../breeder/base/BreederFindManyArgs";
import { Breeder } from "../../breeder/base/Breeder";
...
export class UserControllerBase {
  ...
  @common.Get("/:id/breeders")
  @ApiNestedQuery(BreederFindManyArgs)
  async findBreeders(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<Breeder[]> {
    const query = plainToClass(BreederFindManyArgs, request.query);
    const results = await this.service.findBreeders(params.id, {
      ...query,
      select: {
        id: true,
        createdAt: true,
  ...
  @common.Post("/:id/breeders")
  async connectBreeders(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: BreederWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      breeders: {
        connect: body,
  ...
  @common.Patch("/:id/breeders")
  async updateBreeders(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: BreederWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/breeders")
  async disconnectBreeders(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: BreederWhereUniqueInput[]
  ): Promise<void> {
    const data = {
