...
class BreederCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => MessageCreateNestedManyWithoutBreedersInput,
  })
  @ValidateNested()
  @Type(() => MessageCreateNestedManyWithoutBreedersInput)
  @IsOptional()
  @Field(() => MessageCreateNestedManyWithoutBreedersInput, {
    nullable: true,
  })
...
export { BreederCreateInput as BreederCreateInput };
