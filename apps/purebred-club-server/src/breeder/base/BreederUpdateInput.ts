...
class BreederUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => MessageUpdateManyWithoutBreedersInput,
  })
  @ValidateNested()
  @Type(() => MessageUpdateManyWithoutBreedersInput)
  @IsOptional()
  @Field(() => MessageUpdateManyWithoutBreedersInput, {
    nullable: true,
  })
...
export { BreederUpdateInput as BreederUpdateInput };
